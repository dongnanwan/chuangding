<template>
    <div>
        ...
        <div style="padding-bottom:8px">
            ...
            <div style="display:inline-block">
            <partnerSelect-app :fatherData='fatherList'  @OnGetDataFromChild='getPartnerIdFromChild'></partnerSelect-app>
            </div>
        ...
        <div ref="printTable">
            ...
            <el-table-column sortable="" show-overflow-tooltip prop="shopName" label="店铺" min-width="260" align="center"></el-table-column>
            <el-table-column sortable="" show-overflow-tooltip prop="shopManagerName" label="店长" min-width="80" align="center"></el-table-column>
            ...
            <el-table-column show-overflow-tooltip prop="name" label="赠送"  align="center">
                <el-table-column sortable="" show-overflow-tooltip label="活动赠送金豆" prop="giveAwayVenosa" min-width="120" align="center">
            ...
            <el-table-column show-overflow-tooltip prop="id" label="会员收益" align="center">
                <el-table-column sortable="" show-overflow-tooltip label="推荐会员金豆奖励" prop="recommendMemberBeanAward" min-width="120" align="center">
                
                </el-table-column>
                <el-table-column sortable="" show-overflow-tooltip label="会员消费现金返利" prop="membersCashRebates" min-width="120" align="center">
...
<script>
    ...
    import parterSelect from '../../common/shopInput.vue'
        ...
        methods:{
            ...
            getSummaries(param) {
                ...
                if (!values.every(value => isNaN(value))) {
                    sums[16] = this.totalList.consumptionFortunellaVenosaTotal
                    sums[12] = this.totalList.fortunellaVenosaAwardTotal
                    sums[17] = this.totalList.fortunellaVenosaFreightTotal
                    sums[13] = this.totalList.giveAwayVenosaTotal
                    sums[9] = this.totalList.goldCardNumTotal
                    sums[8] = this.totalList.goldCardTotal
                    sums[15] = this.totalList.membersCashRebatesTotal
                    sums[14] = this.totalList.recommendMemberBeanAwardTotal
                    sums[18] = this.totalList.refundFortunellaVenosaTotal
                    sums[19] = this.totalList.refundVenosaFreightTotal
                    sums[20] = this.totalList.remainingFortunellaVenosaTotal
                    sums[11] = this.totalList.silverCardNumTotal
                    sums[10] = this.totalList.silverCardTotal
                    sums[7] = this.totalList.storedFortunellaVenosaTotal
                    sums[6] = this.totalList.storedValueAmountTotal
                } else {
                }
                });
                return sums;
            ...
            getInfo(){
                ...
                this.params.cityId = this.searchForm.cityId
                this.params.provinceId = this.searchForm.provinceId
                this.$axios.get('/api/salesReserveIncome/getShopReserveAndSettlemenSummary',{params:this.params}).then(res=>{
                    if(res.data.code == 200){
                ...
                then(res=>{
                    if(this.total != 0){
                        this.$axios.get('/api/salesReserveIncome/getShopReserveAndSettlemenSummary',{params:Object.assign(this.paramsExport,this.params,{size:this.total})}).then(res=>{
                            if(res.data.code == 200){
                ...
                this.$axios.get('/api/salesReserveIncome/getShopReserveAndSettlemenSummaryTotal',{params:this.params}).then(res=>{
                    if(res.data.code == 200){
