    ...
    export default {
        ...
        methods:{
            ...
            getSummaries(param) {
                ...
                columns.forEach((column, index) => {
                    ...
                    if (!values.every(value => isNaN(value))) {
                        sums[15] = this.totalList.consumptionFortunellaVenosaTotal
                        sums[11] = this.totalList.fortunellaVenosaAwardTotal
                        sums[16] = this.totalList.fortunellaVenosaFreightTotal
                        sums[12] = this.totalList.giveAwayVenosaTotal
                        sums[9] = this.totalList.goldCardTotal
                        sums[14] = this.totalList.membersCashRebatesTotal
                        sums[13] = this.totalList.recommendMemberBeanAwardTotal
                        sums[17] = this.totalList.refundFortunellaVenosaTotal
                        sums[18] = this.totalList.refundVenosaFreightTotal
                        sums[19] = this.totalList.remainingFortunellaVenosaTotal
                        sums[10] = this.totalList.silverCardTotal
                        sums[8] = this.totalList.storedFortunellaVenosaTotal
                        sums[7] = this.totalList.storedValueAmountTotal
                    } else {
            ...
            getInfo(){
                ...
                this.params.cityId = this.searchForm.cityId
                this.params.provinceId = this.searchForm.provinceId
                this.$axios.get('/api/salesReserveIncome/getMemberReserveAndSettlemenSummary',{params:this.params}).then(res=>{
                    if(res.data.code == 200){
                ...
                then(res=>{
                    if(this.total != 0){
                        this.$axios.get('/api/salesReserveIncome/getMemberReserveAndSettlemenSummary',{params:Object.assign(this.paramsExport,this.params,{size:this.total})}).then(res=>{
                            if(res.data.code == 200){
                ...
                this.$axios.get('/api/salesReserveIncome/getMemberReserveAndSettlemenSummaryTotal',{params:this.params}).then(res=>{
                    if(res.data.code == 200){
