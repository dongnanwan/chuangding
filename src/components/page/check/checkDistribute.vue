<template>
  <div>
      <div style="height:40px">
        <div style="float:left">
          ...
          <div style="margin:10px 0">
            <div style="float:left">
              <ShopIdInputx-app @OnGetShopIdFromChild='GetShopIdFromChildSearch'></ShopIdInputx-app>
            </div>
      ...
      <el-table :data="items" style="width: 100%" height="600"  border highlight-current-row v-loading="indexLoading" element-loading-text="数据加载中......"
          ...
          <el-table-column show-overflow-tooltip width="210" fixed="right"  label="操作">
            <template slot-scope="scope">
      ...
      <el-dialog  :visible.sync="dialogTableVisible" class="detailTable"   fullscreen>
        ...
        <el-button type="primary" @click="dialogTableVisible = false" plain>关闭</el-button>
      </el-dialog>
...
<script>
  ...
  import ShopIdInputx from '../../common/ShopIdInput.vue'
