<template>
    <div>
        ...
        <div style="padding-bottom:8px">
            ...
            <el-input v-model="params.year" placeholder="年份" class="inputSize"></el-input>
        ...
        <div ref="printTable">
            <el-table
                ...
                <el-table-column show-overflow-tooltip label="年份" min-width="80" align="center">
                    <template slot-scope="scope">
                ...
                <el-table-column show-overflow-tooltip sortable="" prop="payment" label="销售额" min-width="80" align="center" ></el-table-column>
                <el-table-column show-overflow-tooltip sortable="" prop="saleNum" label="销售数量" min-width="80" align="center"></el-table-column>
                <el-table-column show-overflow-tooltip sortable="" prop="discount" label="销售折扣" min-width="80" align="center" ></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getInfo() {
            ...
            this.$axios.get('/api/salesAndReturnReport/getMerchandiseSalesReportTotal',{params:this.params}).then(res=>{
                if(res.data.code == 200){
            ...
            this.$axios.get("/api/salesAndReturnReport/getMerchandiseSalesReport", {params: this.params}).then(res => {
                if (res.data.code == 200) {
                ...
                if(this.total != 0){
                    this.$axios.get('/api/salesAndReturnReport/getMerchandiseSalesReport',{params:Object.assign(this.paramsExport,this.params,{size:this.total})}).then(res=>{
                        if(res.data.code == 200){
