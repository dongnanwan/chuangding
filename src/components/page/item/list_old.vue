  ...
  <div>
    <div class="box query-box">
      <el-form :inline="true" :model="params" class="demo-form-inline">
        ...
        <el-button type="primary" plain @click="itemSync">数据同步</el-button>
      </el-form>
    </div>
    <el-table
      border
      ...
      :row-style="rowstyle"
     >
      <el-table-column fixed prop="id" label="ID" sortable  show-overflow-tooltip  min-width="60"></el-table-column>
      ...
      <el-table-column prop="seriesName" label="状态"  show-overflow-tooltip  min-width="70">
        <template slot-scope="scope">
          {{statusNames[scope.row.status]}}
        </template>
      </el-table-column>
      <el-table-column prop="name" label="类目"  show-overflow-tooltip min-width="70">
      ...
      <el-table-column label="标题"  show-overflow-tooltip min-width="190" prop="title"></el-table-column>
      <el-table-column label="副标题"  show-overflow-tooltip min-width="190" prop="title"></el-table-column>
      ...
      <!-- <el-table-column label="价格"  show-overflow-tooltip  width="70">
        <div class="title" slot-scope="scope">{{scope.row.lowPrice}}~{{scope.row.highPrice}}</div>
      </el-table-column> -->
      <!-- <el-table-column prop="totalStock" label="库存"  show-overflow-tooltip  width="70">
      </el-table-column> -->
      ...
      <el-table-column fixed="right" label="操作" min-width="160" show-overflow-tooltip>
        <template slot-scope="scope">
          ...
          <el-button plain="" type="info" @click="showEditDialogue(scope.$index, scope.row)" style="margin:0 5px">编辑</el-button>
        ...
        <el-form label-position="right" label-width="80px" :inline="true">
            ...
            <el-card shadow="hover" style="margin-top:10px">
                ...
                <!-- <ul v-show='showPropertyChangeForm'>
                  <div v-for="(property,index) in itemsProperties" :key="property.id">
                     <el-form-item :label="property.name">
                        <el-select v-model="testarr[index]" ref="propertyChoice"  placeholder="请选择" @change='selectChange(testarr[index])'>
                          <el-option
    ...
    selectChange(a,b){
      ...
      showEditDialogue(index,row){
          ...
          this.$axios.get(`/api/item/${row.id}`).then(res=>{
              ...
              // if(typeof(this.updateForm.property) != 'undefined'){
               
              //     if(typeof(this.updateForm.property.propertyValues) != 'undefined'){
